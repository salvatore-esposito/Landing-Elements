...
$.fn.landingElements = function () {
  var $landingElementGroup = this,
      ...
      distance = 375,
      duration,
      posElement = function posElement() {
    var $this = $(this);
    $this.css({
      'position': 'relative',
      'z-index': '10000',
  ...
  $window.scroll(function () {
    $landingElementGroup.each(function (i, el) {
      ...
      if (triggerDistance - $window.scrollTop() > distance) return;
      var $this = $(el);
...
__webpack_require__(/*! /home/vagrant/shared/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /home/vagrant/shared/src/scss/app.scss */"./src/scss/app.scss");
